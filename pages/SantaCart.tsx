...
export default function SantaCart() {
  ...
  return (
    <main className="h-screen w-screen lg:w-[40%] flex flex-col items-center justify-center mx-auto bg-blur bg-cover shadow-white shadow-lg relative">
      {name === "" ? (
        <Link href="/">
        ...
        <>
          <div className="relative">
            ...
            />
            <h1 className="text-5xl sm:text-8xl lg:text-6xl text-white font-bold">FELIZ NATAL</h1>
          </div>
          ...
          <Lottie
            ...
            className=" w-72 sm:w-96 absolute bottom-0 right-0 scale-90 hover:scale-100 duration-150"
            loop={false}
          />
          <Lottie
            animationData={woodAnimation}
            className=" w-72 sm:w-96 absolute bottom-0 left-0 scale-90 hover:scale-100 duration-150"
            loop={false}
          />
        </>
      )}
